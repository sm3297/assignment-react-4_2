...
// JSX 코드로 jsx practice 하기

const myElement1 = 
   <div class="head_content" style = {{backgroundColor: "white", padding: "10px", borderRadius: "5px", width: "300px"}}>
...
const myElement3 = 
  <div style = {{backgroundColor: "lightgray", display: "block", padding: "20px", width: "400px", textAlign: "center"}}>
      <br />
